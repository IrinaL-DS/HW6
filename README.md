...
**![Итоговая сегментация (CPD) и анализ временного ряда MoMA](moma_time_series_segmentation.png)**
...
**![Поиск аномальных всплесков в истории закупок MoMA](moma_anomaly_analysis.png)**
...
**![Визуализация ошибок прогнозирования (Actual vs Predicted)](prediction_errors.png)**

График сравнения реальных данных и прогноза подтверждает, что модель успешно уловила общую динамику тренда.

**![Важность признаков для прогноза закупок MoMA](feature_importance.png)**
...
**![Метрики качества обученной модели XGBoost](model_metrics_quality.png)**
